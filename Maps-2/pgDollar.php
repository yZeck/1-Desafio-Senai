...
<section class="container">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="pgDollar.php">Gráfico - Salário-Dollar</a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
    <a class="nav-link" href="pgProcessador">Gráfico - Salário-Processador</a>
  </li>
</ul>
</section>
