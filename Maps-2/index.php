...
<section class="container">
  ...
  <li class="nav-item">
    <a class="nav-link active" aria-current="page" href="index.php">Gráfico - Salário-Gasolina</a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
    <a class="nav-link" href="pgCestaBasica.php">Gráfico - Salário-Cesta- Básica</a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
    ...
    <section class="container">
    <h1>Gráfico Salário/Gasolina</h1>
...
<section class="container" >
  ...
  <section class="inserir">
    <h6>Inserir Dados na data base:</h6>
...
<tr>
  ...
  <input type="hidden" name="table" value="<?=$table?>"  readonly>
  <input type="hidden" name="pg" value="<?=$pg?>"  readonly>
  <button id="bt1"> Editar Dados!</button>
  ...
  <input type="hidden" name="table" value="<?=$table?>"  readonly>
  <input type="hidden" name="pg" value="<?=$pg?>"  readonly>
  <button id="bt2" >Deletar Dados</button>
